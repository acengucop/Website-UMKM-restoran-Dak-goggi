...
class MenuItem(models.Model):
    name = models.CharField(max_length=100)
    Bonus = models.CharField(max_length=100)  # contoh: "+ FREE 1 RICEBOWL"
    description = models.TextField(blank=True)
    price = models.PositiveIntegerField()  # dalam rupiah, misalnya 50000
...
class MiniItem(models.Model):
    ...
    name = models.CharField(max_length=100)
    description = models.TextField(blank=True)
    price = models.PositiveIntegerField()  # dalam rupiah
